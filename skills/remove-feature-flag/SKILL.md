...
description: Remove a stabilized host feature gate and the dead branches behind it while preserving placeholder comments for HOST_FEATURE_FLAG_SYSTEM and validation command. Do not invoke if HOST_FEATURE_FLAG_SYSTEM is unbound.
---

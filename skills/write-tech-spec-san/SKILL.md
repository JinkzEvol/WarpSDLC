---
name: write-tech-spec-san
description: Write a host-neutral TECH.md from an approved product spec and preserve placeholder comments for host validation commands, spec roots, and architecture review expectations.
---

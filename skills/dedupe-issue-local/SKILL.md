...
description: Apply host-specific duplicate-issue heuristics on top of a core issue workflow and preserve placeholder comments for the host core, HOST_LABEL_TAXONOMY, and duplicate policy. Do not invoke if HOST_LABEL_TAXONOMY is unbound.
---

...
description: Add or improve Rust unit tests in a host repository and keep placeholder comments for HOST_RUST_TEST_ROOT and local test conventions; if the host is not a Rust repo, move this skill to SDLC-bench. Do not invoke if HOST_RUST_TEST_ROOT is unbound.
---

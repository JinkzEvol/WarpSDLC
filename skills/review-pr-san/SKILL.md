---
name: review-pr-san
description: Review a checked-out pull request diff from local artifacts and produce structured review output using host-bound severity and publishing placeholders instead of repo-specific review rules.
---

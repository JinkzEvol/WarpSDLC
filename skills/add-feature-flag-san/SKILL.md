---
name: add-feature-flag-san
description: Add a host-bound feature gate for risky or staged work and preserve placeholder comments for the host flag registry, rollout stages, and feature-gate system.
---

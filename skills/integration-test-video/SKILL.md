...
description: Capture visual evidence for host integration tests only when the host provides HOST_VIDEO_CAPTURE and a compatible test harness; otherwise keep the sanitized module available for SDLC-bench. Do not invoke if HOST_VIDEO_CAPTURE is unbound.
---
